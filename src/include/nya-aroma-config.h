...
char *flashSource[] = {"tsukika/system.img", "tsukika/vendor.img"};
...
// additional valulues will get ignored by the script, because it's the nature.
// Option names:

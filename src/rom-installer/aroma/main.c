...
int help(char *execBinName) {
    ...
    printf(" _| || |_  |_   _|__ _   _| | _(_) | ____ _ \n");
    printf("|_  ..  _|   | |/ __| | | | |/ / | |/ / _  |\n");
    printf("|_      _|   | |\\__ \\ |_| |   <| |   < (_| |\n");
    printf("  |_||_|     |_||___/\\__,_|_|\\_\\_|_|\\_\\__,_|\n");
    printf("\n");
    printf("########################################################################\n");
...
int main(int argc, char *argv[]) {
    ...
    if(strcmp(argv[1], "--aroma") == 0) {
        ...
        if(!aromaConfig) {
            printf("\e[0;31mPlease either make \"META-INF/com/google/android/\" directory or simply execute this in the cloned dir (to be exact, im talking about Tsukika/src/rom-installer/aroma/ directory)\e[0;37m\n");
            return 1;
        }
        fprintf(aromaConfig, "ini_set(\"force_colorspace\", \"rgba\");\n");
        fprintf(aromaConfig, "ini_set(\"rom_name\", \"Tsukika\");\n");
        ...
        fprintf(aromaConfig, "    \"<b><#selectbg_g>For Tsukika</#></b>.\"+\n");
        ...
        if(!updater_script) {
            printf("\e[0;31mERROR: Please either make \"META-INF/com/google/android/\" directory or simply execute this in the cloned dir (to be exact, im talking about Tsukika/src/rom-installer/aroma/ directory)\e[0;37m\n");
            return 1;
        }
        ...
        fprintf(updater_script, "\nconsolePrint \"Tsukika - %s for %s | Built by %s\"", codename, deviceName, mainAuth);
